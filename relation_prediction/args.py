...
def get_args():
    ...
    parser.add_argument('--gpu', type=str, default=0)  # Use -1 for CPU
    ...
    parser.add_argument('--fix_embed', default=True, dest='train_embed')
    ...
    parser.add_argument('--trained_model', type=str, default='./saved_checkpoints/cnn/id1_best_model.pt')
